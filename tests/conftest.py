"""
Shared fixtures for the TA-nextdns-api integration suite.
...
Environment (defaults suit the docker harness):
  ...
  SPLUNK_CONTAINER  container name for     (default ta_nextdns_api_splunk)
...
CONTAINER = os.environ.get("SPLUNK_CONTAINER", "ta_nextdns_api_splunk")
APP = "TA-nextdns-api"
